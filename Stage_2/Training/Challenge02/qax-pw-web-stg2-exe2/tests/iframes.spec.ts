...
test.describe('Comportamientos avanzados — Iframes', () => {
  ...
  // Queda fixme por BUG-002: el texto del locator coincide con dos elementos.
  test.fixme('Interactuar con iframe simple', async ({ page }) => {
  ...
  // Queda fixme por BUG-003: no se encuentra el campo del iframe hijo.
