...
test.describe('Comportamientos avanzados — Alertas y Modales', () => {
  ...
  // Queda fixme por BUG-001: el clic queda esperando mientras la alerta esta abierta.
  test.fixme('Alerta simple — aceptar', async ({ page }) => {
  ...
  // Queda fixme por BUG-001: comparte el helper de alertas nativas.
  test.fixme('Confirmar — aceptar (OK)', async ({ page }) => {
  ...
  // Queda fixme por BUG-001: comparte el helper de alertas nativas.
  test.fixme('Confirmar — cancelar', async ({ page }) => {
  ...
  // Queda fixme por BUG-001: comparte el helper de alertas nativas.
  test.fixme('Prompt — ingresar texto', async ({ page }) => {
